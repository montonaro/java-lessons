...
public class Convert {
	...
	/**
	 * метод дл€ проверки на корректный ввод числа
	 * @param str -  уже проверенна€ на пустоту
	 * @param max - верхн€€ граница до какой проходит true
	 * @return true/false
	 */
				...
				if(!str.equals(null)){  
					...
					if(decimal){
						try {
							...
							System.out.println( "ќшибка ввода  " + e.toString());
						}
